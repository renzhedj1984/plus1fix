 ...
 */
@Modules(scanPackage = true, packages = {"cn.wizzer.modules","com.plus1fix"})
@Ok("json:full")
@Fail("http:500")
@IocBy(type = ComboIocProvider.class, args = {"*json", "config/ioc/", "*anno", "cn.wizzer","com.plus1fix", "*tx", "*quartz", "*async"})
